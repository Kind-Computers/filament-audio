...
#else
	CReverb() { }
	void Initialize(bool, MixSampleInt &, MixSampleInt &, uint32) { }
	void TouchReverbSendBuffer(MixSampleInt *, MixSampleInt &, MixSampleInt &, uint32) { }
	void Process(MixSampleInt *, MixSampleInt *, MixSampleInt &, MixSampleInt &, uint32) { }
#endif
