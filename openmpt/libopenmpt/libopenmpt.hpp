...
public:
	...
	*/
	LIBOPENMPT_CXX_API_MEMBER double get_current_channel_vu_mono( std::int32_t channel ) const;
	...
	/*!
	  ...
	  \remarks The returned value is solely based on the note velocity and does not take the actual waveform of the playing sample into account.
	*/
	LIBOPENMPT_CXX_API_MEMBER double get_current_channel_vu_left( std::int32_t channel ) const;
	...
	/*!
	  ...
	  \remarks The returned value is solely based on the note velocity and does not take the actual waveform of the playing sample into account.
	*/
	LIBOPENMPT_CXX_API_MEMBER double get_current_channel_vu_right( std::int32_t channel ) const;
	...
	/*!
	  ...
	  \remarks The returned value is solely based on the note velocity and does not take the actual waveform of the playing sample into account.
	*/
	LIBOPENMPT_CXX_API_MEMBER double get_current_channel_vu_rear_left( std::int32_t channel ) const;
	...
	/*!
	  ...
	  \remarks The returned value is solely based on the note velocity and does not take the actual waveform of the playing sample into account.
	*/
	LIBOPENMPT_CXX_API_MEMBER double get_current_channel_vu_rear_right( std::int32_t channel ) const;
