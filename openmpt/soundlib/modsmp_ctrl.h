...
// Resets per-channel mixer state that depends on the sample rate after a live
// waveform / rate swap: IIR filter memory, β-shear resampler history,
// output DC-offset buffers, and in-flight volume ramps. Sample position,
// envelopes, and LFO phases are intentionally left intact so the note keeps
