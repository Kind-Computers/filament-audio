...
void CSoundFilePlayConfig::SetMixLevels(MixLevels mixLevelType)
{
	switch (mixLevelType)
	{
		...
		case MixLevels::Original:
			...
			setIntToFloat(1.0f/static_cast<double>(1<<28));
			setFloatToInt(static_cast<double>(1<<28));
		...
		case MixLevels::v1_17RC1:
			...
			setIntToFloat(1.0f/static_cast<double>(0x07FFFFFFF));
			setFloatToInt(static_cast<double>(0x07FFFFFFF));
			setGlobalVolumeAppliesToMaster(false);
			setUseGlobalPreAmp(true);
			setPanningMode(PanningMode::Undetermined);
			setDisplayDBValues(false);
		...
		case MixLevels::v1_17RC2:
			...
			setIntToFloat(1.0 / static_cast<double>(MIXING_SCALEF));
			setFloatToInt(static_cast<double>(MIXING_SCALEF));
