...
//getters/setters
	...
	double getIntToFloat() const { return m_IntToFloat; }
	void  setIntToFloat(double inIntToFloat) { m_IntToFloat = inIntToFloat; }

	double getFloatToInt() const { return m_FloatToInt; }
	void  setFloatToInt(double inFloatToInt) { m_FloatToInt = inFloatToInt; }
